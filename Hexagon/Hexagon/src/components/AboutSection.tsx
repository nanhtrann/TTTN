...
export const AboutSection = (props: any) => {
  ...
  const description = props.description || t.desc;
        ...
        <div className="w-full md:w-1/2 relative flex justify-center items-center">
          ...
          <div className="absolute -bottom-10 -right-4 bg-white p-6 rounded-xl shadow-2xl max-w-xs border-l-4 border-yellow-500 z-20">
            <p className="italic text-gray-700 font-medium leading-relaxed">
              {props.quote || (t as any).quote || "Làm ngày, làm đêm, làm thêm ngày nghỉ ^_^"}
            </p>
            <p className="text-yellow-600 font-bold mt-2 text-sm">{props.quoteAuthor || (t as any).quoteAuthor || '— HEXAGON CULTURE'}</p>
          </div>
        </div>
